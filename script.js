...
const expresssionDiv = document.getElementById('expression');
const resultDiv = document.getElementById('result');

//Define expression & reult variable
let expression = '';
let result = '';
...
function buttonClick(event) {
    ...
    switch (action) {
        ...
        case 'backspace':
            backspace();
            break;
            //add result to expression as a statring point if exp is empty
        case 'addition':
        case 'subtraction':
        case 'multiplication':
        case 'division':
...
function updateDisplay(expression, result) {
    expresssionDiv.textContent = expression;
